    ...
    **Instructions:**
    ...
    try:
       with open(filename, "r") as f:
        log_lines = f.readlines()# open the access.log file and read the lines into a list (ideally named log_lines if you want to use the code from the instruction page)
    ...
    for url, count in url_count.items():
        print(f'    {url}: {count}')
    # I went back to check if there was an easier way for the spacing and just assumed it was a tab.
    '''
